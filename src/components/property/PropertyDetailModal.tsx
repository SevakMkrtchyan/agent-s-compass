  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-stretch justify-end pointer-events-none">
        <div 
          className="pointer-events-auto w-full max-w-3xl bg-background shadow-2xl animate-slide-in-right flex flex-col"
                    ...
                    {property.listingAgent ? (
                      <div className="space-y-3">
                        ...
                        {property.listingAgent.phone && (
                          <p className="text-muted-foreground">{property.listingAgent.phone}</p>
                        )}
                        {property.listingAgent.email && (
                          <p className="text-muted-foreground">{property.listingAgent.email}</p>
                        )}
                      </div>
                    ) : (
                      <p className="text-muted-foreground italic">
